...
def run_pid(pid, ephys_path, out_path, regions=None, loc_suffix=""):
...
if __name__ == "__main__":
    ...
    for i, pid in enumerate(args.pids):
        ...
        allprocs.append(run_pid(pid, ephys_path, args.out_path, regions=region, loc_suffix=args.loc_suffix))
